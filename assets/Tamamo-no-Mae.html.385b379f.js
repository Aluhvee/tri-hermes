const data = {
  "key": "v-4ba3acfb",
  "path": "/Servants/Profiles/Tamamo-no-Mae.html",
  "title": "Tamamo-no-Mae",
  "lang": "en-US",
  "frontmatter": {
    "summary": "Tamamo-no-Mae This material is translated by u/WaifuHunter Info Bio-Data Class: Caster; True name: Tamamo-no-Mae; Source: Japanese mythology, one of the 3 Great Metamorphosis of Ja",
    "head": [
      [
        "meta",
        {
          "property": "og:url",
          "content": "https://r-grandorder.github.io/Servants/Profiles/Tamamo-no-Mae.html"
        }
      ],
      [
        "meta",
  ...
  "headers": [
    ...
    {
      "level": 2,
      "title": "Role in other works",
      "slug": "role-in-other-works",
      "children": []
    },
    {
      "level": 2,
  ...
  "filePathRelative": "Servants/Profiles/Tamamo-no-Mae.md"
};
export { data };
