const data = {
  "key": "v-375ef99d",
  "path": "/Servants/Profiles/Mysterious-Heroine-X-Alter.html",
  "title": "Mysterious Heroine X Alter",
  "lang": "en-US",
  "frontmatter": {
    "summary": "Mysterious Heroine X Alter This material is translated by u/KingofPadoru Info Bio-Data True Name: Mysterious Heroine X (Alter); Class: Berserker (the person herself claims to be Sa",
    "head": [
      [
        "meta",
        {
          "property": "og:url",
          "content": "https://r-grandorder.github.io/Servants/Profiles/Mysterious-Heroine-X-Alter.html"
        }
      ],
      [
        "meta",
  ...
  "filePathRelative": "Servants/Profiles/Mysterious-Heroine-X-Alter.md"
};
export { data };
